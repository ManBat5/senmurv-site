    ...
    <div className='min-h-screen w-full bg-black text-white'>
      <section id='top' className='relative h-screen flex items-center justify-center text-center overflow-hidden'>
        ...
        <div className='relative z-10'>
          <h1 className='text-5xl sm:text-7xl font-semibold'>AI-Driven Automation for Every Operation</h1>
        </div>
      </section>
      ...
      <section id='capabilities' className='py-20 text-center'>
        ...
        <a href='#contact' className='mt-4 inline-block rounded-2xl bg-white text-black px-6 py-3 font-medium'>Apply for Pilot</a>
      </section>
